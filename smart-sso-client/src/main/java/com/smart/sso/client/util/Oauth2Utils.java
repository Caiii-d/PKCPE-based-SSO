...
public class Oauth2Utils {
	 ...
	 * @return
	 */
	public static Result<RpcAccessToken> getAccessToken(String serverUrl, String appId, String appSecret, String code, Object verifier ) {
		Map<String, String> paramMap = new HashMap<>();
		...
		paramMap.put(Oauth2Constant.CODE_VERIFIER, (String) verifier);
		return getHttpAccessToken(serverUrl + Oauth2Constant.ACCESS_TOKEN_URL, paramMap);
	}
